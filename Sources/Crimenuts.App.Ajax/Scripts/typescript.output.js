        ...
        (function (Process) {
            var Answers = (function (_super) {
                ...
                Answers.prototype.createButton = function (text, callback, position) {
                    var button = new Crimenuts.RoundedRectangleDecor(new Crimenuts.TextDecor(new Crimenuts.Button(this.game, callback, this, Crimenuts.Settings.UserInterface.Button.width, Crimenuts.Settings.UserInterface.Button.height), text, Crimenuts.Settings.UserInterface.Button.textColor, Crimenuts.Settings.UserInterface.Button.fontSize), Crimenuts.Settings.UserInterface.Button.fillColor, Crimenuts.Settings.UserInterface.Button.lineColor, Crimenuts.Settings.UserInterface.Button.lineWidth);
