        ...
        (function (Process) {
            var InfoBar = (function (_super) {
                ...
                InfoBar.prototype.createTextLabel = function () {
                    this.add(this.textLabel = new Crimenuts.TextLabel(Crimenuts.Settings.Process.Bars.width, Crimenuts.Settings.Process.Bars.height, Crimenuts.Settings.Default.Font.face, Crimenuts.Settings.Process.Bars.fontSize, Crimenuts.Settings.Process.Bars.textColor, Crimenuts.Settings.Process.Bars.bgColor));
                };
