    ...
    (function (Settings) {
        ...
        (function (UserInterface) {
            ...
            (function (Button) {
                ...
                var Default;
                (function (Default) {
                    Default.lineWidth = Button.lineWidth;
                    var Regular;
                    (function (Regular) {
                    ...
                    (function (Hover) {
                        ...
                        Hover.lineColor = Hover.lineColor;
...
(function (Crimenuts) {
    var DefaultButton = (function (_super) {
        ...
        DefaultButton.prototype.createButton = function (text, callback, callbackContext) {
            var essence = new Crimenuts.Button(this.game, callback, callbackContext, Crimenuts.Settings.UserInterface.Button.width, Crimenuts.Settings.UserInterface.Button.height);
            var regularDecor = new Crimenuts.RoundedRectangleDecor(new Crimenuts.TextDecor(new DecorableProxy(essence), text, Crimenuts.Settings.UserInterface.Button.Default.Regular.textColor, Crimenuts.Settings.UserInterface.Button.fontSize), Crimenuts.Settings.UserInterface.Button.Default.Regular.fillColor, Crimenuts.Settings.UserInterface.Button.Default.Regular.lineColor, Crimenuts.Settings.UserInterface.Button.Default.lineWidth);
            //            regularDecor.visible = false;
            var hoverDecor = new Crimenuts.RoundedRectangleDecor(new Crimenuts.TextDecor(new DecorableProxy(essence), text, Crimenuts.Settings.UserInterface.Button.Default.Hover.textColor, Crimenuts.Settings.UserInterface.Button.fontSize), Crimenuts.Settings.UserInterface.Button.Default.Hover.fillColor, Crimenuts.Settings.UserInterface.Button.Default.Hover.lineColor, Crimenuts.Settings.UserInterface.Button.Default.lineWidth);
    ...
    var DecorableProxy = (function (_super) {
        ...
        function DecorableProxy(essence) {
            _super.call(this, essence.getGame());
            this.essence = essence;
        }
        DecorableProxy.prototype.getGame = function () {
