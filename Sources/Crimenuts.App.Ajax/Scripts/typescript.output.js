            ...
            (function (Members) {
                ...
                (function (Dialog) {
                    ...
                    (function (Name) {
                        ...
                        Name.height = 25 * k;
                        Name.color = "#000000";
                        Name.bgColor = 0xAAAAAA;
                    })(Name = Dialog.Name || (Dialog.Name = {}));
        ...
        (function (Process) {
            var ProcessView = (function (_super) {
                ...
                ProcessView.prototype.createParts = function (controller, observer, model) {
                    ...
                    this.addPart(dialog = new Process.MemberDialog(model));
    ...
    (function (View) {
        ...
        (function (Process) {
            var MemberCard = (function (_super) {
                ...
                function MemberCard(world, member, x, y, w, h, command) {
                    _super.call(this, Crimenuts.app.game);
            ...
            var Members = (function (_super) {
                ...
                Members.prototype.createMembers = function (world, members, dialog) {
                    ...
                    for (var i in members) {
                        ...
                        var name = members[i];
                        this.add(new Process.MemberCard(world, name, p.x, p.y, w, h, new Crimenuts.MemberDialogCommand(dialog, i)));
                    }
                };
