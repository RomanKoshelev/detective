...
namespace Crimenuts.Core.Game.Process
{
    public partial class Process
    {
        ...
        private IList< Member.Member > GetQuestioningRespondents()
        {
        ...
        private bool AddQuestionsForRespondent( Member.Member respondent )
        {
            if( respondent != null ) {
        ...
        // ===================================================================================== []
        // Rules
        private bool CanAskAbout( Member.Member correspondent, Member.Member subject )
        {
        ...
        private bool CanBeQuestioned( Member.Member member )
        {
            return History.GetAnswers( member, Today ).Count == 0;
        }

        private static bool CanBeArrested( Member.Member member )
        {
