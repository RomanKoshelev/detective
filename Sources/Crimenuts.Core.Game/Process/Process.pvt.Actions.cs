...
namespace Crimenuts.Core.Game.Process
{
    public partial class Process
    {
        ...
        private Answer DoAsk( Member.Member respondent, Member.Member subject )
        {
        ...
        private void DoArrest( Member.Member suspect )
        {
        ...
        private void DoEarlyArrest( Member.Member suspect )
        {
